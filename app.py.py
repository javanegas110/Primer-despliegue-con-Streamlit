# -*- coding: utf-8 -*-
"""7. Despliegue_Videojuegos.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GPGdtJWoVYkSf6DyQJJbJVJTZUjBZ7Yu
...
#Se adicionan las columnas faltantes. En el despliegue no tengo todas las columnas del modelo. Con el reindex elimino y adiciono de acuerdo al modelo inicial
